 ...
 */
package com.toyon.demohelloworld.samplelayer;
...
/** The accompanying GL Layer for the Example Image Layer */
public class GLExampleLayer extends GLAbstractLayer {

    /** GLLayerSpi automatically creates an instance of the renderer
     * when the ExampleLayer is added to the map
     */
    ...
    public void setData(int[] argb, final int width, final int height,
            GeoPoint upperLeft, GeoPoint upperRight, GeoPoint lowerRight, GeoPoint lowerLeft) {
    ...
    private static class Data {
        ...
        void update(Bitmap frame, final int width, final int height,
                ...
                final GeoPoint ll) {
            // if the bitmap data exceeds the bounds of the texture, allocate a new instance
