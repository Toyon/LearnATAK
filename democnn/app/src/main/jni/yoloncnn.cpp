...
JNIEXPORT jboolean
Java_com_atakmap_android_democnn_NcnnYolov7_loadModel(JNIEnv* env, jobject thiz, jobject assetManager)
{
    jint modelid = 0;
    jint cpugpu = 0;
...
Java_com_atakmap_android_democnn_NcnnYolov7_createCamera(JNIEnv* env, jobject thiz)
{
...
JNIEXPORT jboolean JNICALL
Java_com_atakmap_android_democnn_NcnnYolov7_openCamera(JNIEnv* env, jobject thiz)
{
...
JNIEXPORT jboolean JNICALL
Java_com_atakmap_android_democnn_NcnnYolov7_closeCamera(JNIEnv* env, jobject thiz)
{
...
JNIEXPORT jboolean JNICALL
Java_com_atakmap_android_democnn_NcnnYolov7_destroyCamera(JNIEnv* env, jobject thiz)
{
...
JNIEXPORT jboolean JNICALL
Java_com_atakmap_android_democnn_NcnnYolov7_setOutputWindow(JNIEnv* env, jobject thiz, jobject surface)
{
...
JNIEXPORT jboolean JNICALL
Java_com_atakmap_android_democnn_NcnnYolov7_releaseOutputWindow(JNIEnv* env, jobject thiz, jobject surface)
{
...
Java_com_atakmap_android_democnn_NcnnYolov7_capture(JNIEnv * env , jobject thiz ) {
    if (g_camera == nullptr)
        return;
    capture = true;
