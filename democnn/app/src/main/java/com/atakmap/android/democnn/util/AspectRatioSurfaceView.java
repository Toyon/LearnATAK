package com.atakmap.android.democnn.util;
...
public class AspectRatioSurfaceView extends SurfaceView {
    ...
    public AspectRatioSurfaceView(Context context, AttributeSet attrs) { super(context, attrs); }

    public AspectRatioSurfaceView (Context context) { super(context); }
