...
/**
 * This class opens up the android's default camera and allows a user to take a photo.
 * After the user likes their photo and hits okay, the MainDropDownReceiver will
 * receive the photo and send it to be classified
 */
...
public class CameraActivity extends Activity {
    ...
    private static final String CAMERA_INFO = "com.toyon.ydsestimator.PHOTO";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Intent camera_intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        // These are a vain attempt to force the default camera app to launch with the back camera
        // The camera app will launch with the previous saved configuration (back/front facing)
