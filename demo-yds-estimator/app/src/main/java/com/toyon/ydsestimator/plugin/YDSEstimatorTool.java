...
import com.toyon.ydsestimator.MainDropDown;
...
/** YDS Estimator's entry in the ATAK Toolbar */
public class YDSEstimatorTool extends Tool implements ToolDescriptor {

    private final Context context;

    public YDSEstimatorTool(Context context) {
    ...
    public void onActivate(Activity arg0, MapView arg1, ViewGroup arg2,
        ...
        Intent i = new Intent(
                MainDropDown.SHOW_MAIN_PANE);//ReportDropDown.SHOW_PLUGIN);
