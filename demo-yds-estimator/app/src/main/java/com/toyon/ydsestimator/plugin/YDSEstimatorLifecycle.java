 ...
 */
package com.toyon.ydsestimator.plugin;
...
import com.toyon.ydsestimator.YDSEstimatorMapComponent;
...
public class YDSEstimatorLifecycle implements Lifecycle {
    ...
    public YDSEstimatorLifecycle(Context ctx) {
    ...
    public void onCreate(final Activity arg0,
        ...
        YDSEstimatorLifecycle.this.overlays
                .add(new YDSEstimatorMapComponent());

        // create components
        Iterator<MapComponent> iter = YDSEstimatorLifecycle.this.overlays
                .iterator();
        MapComponent c;
        while (iter.hasNext()) {
            c = iter.next();
            try {
                c.onCreate(YDSEstimatorLifecycle.this.pluginContext,
                        arg0.getIntent(),
                        YDSEstimatorLifecycle.this.mapView);
            } catch (Exception e) {
                Log.w(TAG,
