 ...
 */
package com.atakmap.android.cameratemplate.plugin;
...
import com.atakmap.android.cameratemplate.PluginTemplateMapComponent;
...
/**
 * Main plugin entry point of Camera Template Plugin handling ATAK's lifecycle callbacks and
 * loads main MapComponents.
 * TODO: refactor > rename this class to <PLUGIN_NAME>Lifecycle
 */
public class PluginTemplateLifecycle implements Lifecycle {
    ...
    private final static String TAG = PluginTemplateLifecycle.class.getSimpleName();
