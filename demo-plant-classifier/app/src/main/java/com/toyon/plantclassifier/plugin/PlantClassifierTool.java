...
/** Plant Classifier's entry in the ATAK toolbar */
public class PlantClassifierTool extends Tool implements ToolDescriptor {

    private final Context context;

    public PlantClassifierTool(Context context) {
    ...
    public Drawable getIcon() {
        return (context == null) ? null :
                ResourcesCompat.getDrawable(context.getResources(), R.drawable.ic_plant, null);
    }
